...
`listbox` option menu that can be navigated with your keyboard. The returned value is a `string` _not_ a `Date`.

[View source](https://github.com/strapi/design-system/tree/main/packages/design-system/src/TimePicker)
