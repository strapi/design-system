...
A `TimePicker` is used to select a specific time. The input is modelled around the [`Combobox`](https://github.com/strapi/design-system/tree/main/packages/strapi-design-system/src/Combobox) ARIA pattern with a `listbox`
...
TimePicker wrapped with [`Field`](https://github.com/strapi/design-system/tree/main/packages/strapi-design-system/src/Field) component to create a powerful complete form input
