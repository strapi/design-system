...
[View source](https://github.com/strapi/design-system/tree/main/packages/design-system/src/Select)
...
SingleSelect decorated with the
[`Field`](https://github.com/strapi/design-system/tree/main/packages/design-system/src/Field) component

<Canvas of={SelectStories.SingleSelectField} />

### Multiple Select Field

MultiSelect decorated with the
[`Field`](https://github.com/strapi/design-system/tree/main/packages/design-system/src/Field) component
