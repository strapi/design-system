...
SingleSelect decorated with the [`Field`](https://github.com/strapi/design-system/tree/main/packages/strapi-design-system/src/Field) component

<Canvas of={SelectStories.SingleSelectField} />

### Multiple Select Field

MultiSelect decorated with the [`Field`](https://github.com/strapi/design-system/tree/main/packages/strapi-design-system/src/Field) component
