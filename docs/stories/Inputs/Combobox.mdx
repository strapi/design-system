...
the [`Select`](/docs/design-system-components-select--basic) component!

[View source](https://github.com/strapi/design-system/tree/main/packages/design-system/src/Combobox)
