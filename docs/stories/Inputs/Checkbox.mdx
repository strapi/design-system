...
[View source](https://github.com/strapi/design-system/tree/main/packages/design-system/src/Checkbox)
...
- Use the [Radio](https://github.com/strapi/design-system/tree/main/packages/design-system/src/Radio) button component
  if the user should select only one value.
...
[`Field`](https://github.com/strapi/design-system/tree/main/packages/design-system/src/Field) component to create a
powerful complete form input
