...
The design-system we provide empowers individuals to build consistent expierences across the Strapi application. This
...
within the confines of Strapi's design styles. Whyen adding new ones, think about how we can promote this flexibility
without complext prop drilling.
