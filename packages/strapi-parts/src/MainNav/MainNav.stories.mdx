          ...
          <MainNav condensed={condensed}>
            ...
            <NavSections>
              ...
              <NavSection label="General">
                ...
                <NavLink to="/content" badgeContent={'1'} icon={<MarketPlaceIcon />} badgeAriaLabel="notifications">
                  Marketplace
                </NavLink>
                <NavLink to="/content" badgeContent={2} icon={<SettingsIcon />} badgeAriaLabel="notifications">
                  Settings
                </NavLink>
              </NavSection>
            </NavSections>
