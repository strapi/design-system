...
import { NavUser, NavUserInitials } from './NavUser';
      ...
      return (
        <Box background="neutral100" padding={10} style={{ height: '100vh' }}>
          <MainNav condensed={condensed}>
            ...
            <NavUserInitials onClick={() => setUserVisible((prev) => !prev)} ref={navUserRef} initials="JD">
              John Duff
            </NavUserInitials>
            {userVisible && (
              <Popover source={navUserRef} spacing={2}>
                <Stack>
                  <Text>Profile</Text>
                  <Text>Logout</Text>
                </Stack>
