...
- Radio buttons should be used when there is a least two options.
- Content of the Radio button should be concise and straightforward.
- Use the Checkbox component if the user could select one or several value.
...
- Use Switch or Toogle component to make binary choices.
