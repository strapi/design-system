...
<Meta title="Design System/Components/SubNav" component={SubNav} />
...
import AlertInfoIcon from '@strapi/icons/AlertInfoIcon';
import { MemoryRouter } from 'react-router-dom';
import { SubNav, SubNavHeader, SubNavSection, SubNavSections, SubNavLink, SubNavLinkSection } from '@strapi/parts/SubNav';
