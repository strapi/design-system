...
The Sub Navigation is available and displayed on predefined sections of the admin panel to access advanced options (i.e. Content Manager, Content-types Builder and Settings). Thanks to it the users can easily navigation from an entry or a page to another. The Sub Navigation cannot be collapsed.
...
The Sub Navigation cannot be collapsed. A notification system can appear in the Sub Navigation, especially in the Settings section for the Application page. 
...
Related pages are gathered under specific headers within the Sub Navigation. These headers are helpful to understand the section hierarchy. Moreover, each page gets its very own icon to make it distinctive. 

[View source](https://github.com/strapi/parts/tree/develop/packages/strapi-parts/src/SubNav)
...
import AlertInfoIcon from '@strapi/icons/AlertInfoIcon';
import { MemoryRouter } from 'react-router-dom';
import { SubNav } from '@strapi/parts/SubNav';
import { SubNavHeader } from '@strapi/parts/SubNavHeader';
import { SubNavSection } from '@strapi/parts/SubNavSection';
import { SubNavSections } from '@strapi/parts/SubNavSections';
import { SubNavLink } from '@strapi/parts/SubNavLink';
import { SubNavLinkSection } from '@strapi/parts/SubNavLinkSection';
