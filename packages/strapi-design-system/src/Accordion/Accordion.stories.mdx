        ...
        <div>
          <Box padding={8} background="neutral0">
            <AccordionGroup
              footer={
                <Flex justifyContent="center" height="48px" background="neutral150">
                  <TextButton disabled={true} startIcon={<AddIcon />}>Add an entry</TextButton>
                </Flex>
              }
              label="Label"
              labelAction={
            ...
            >
              <Accordion expanded={expanded} toggle={() => setExpanded((s) => !s)} id="acc-1" size="S">
                <AccordionToggle 
                  action={
                    ...
                    titleIcon={<HelpIcon aria-hidden={true} />}
                    togglePosition="left" 
                  />
                <AccordionContent>
                  <Box padding={3}>My name is John Duff</Box>
              ...
              <Accordion disabled={true} expanded={expanded} toggle={() => setExpanded((s) => !s)} id="acc-2" size="S" variant="secondary">
                <AccordionToggle title="User informations" togglePosition="left" />
                <AccordionContent>
                  <Box padding={3}>My name is John Duff</Box>
                </AccordionContent>
