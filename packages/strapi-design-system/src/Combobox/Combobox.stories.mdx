...
`Combobox` can display error. The error message is customizable and replace the description line below the writing area.
...
The creatable mode of `Combobox` allows to create a new option available as a value.
