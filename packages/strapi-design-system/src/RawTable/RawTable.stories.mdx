...
[View source](https://github.com/strapi/design-system/tree/develop/packages/strapi-design-system/src/RawTable)

## Imports

```js
import { RawTable, RawTh, RawTd, RawTr, RawThead, RawTbody } from '@strapi/design-system/RawTable';
```
