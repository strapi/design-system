...
`NumberInput` are always found in forms. They give users the possibility to add or edit numbers.
...
`NumberInput` can display error. The error message is customizable and replace the description line below the writing area.
