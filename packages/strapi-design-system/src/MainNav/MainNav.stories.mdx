...
import { MainNavProvider, useMainNav } from './useMainNav';
...
- Logo asset on the top-left of the Main Navigation can be customized.
  [View source](https://github.com/strapi/design-system/tree/develop/packages/strapi-design-system/src/MainNav)

## Imports

```js
import Write from '@strapi/icons/Write';
import Layer from '@strapi/icons/ContentTypeBuilderIcon';
import Landscape from '@strapi/icons/MediaLibrary';
import Information from '@strapi/icons/Information';
import Puzzle from '@strapi/icons/PluginsIcons';
import ShoppingCart from '@strapi/icons/MarketplaceIcon';
import Cog from '@strapi/icons/Settings';
import { MemoryRouter } from 'react-router-dom';
import { MainNav } from '@strapi/design-system/MainNav';
import { NavSection } from '@strapi/design-system/NavSection';
import { NavSections } from '@strapi/design-system/NavSections';
import { NavCondense } from '@strapi/design-system/NavCondense';
import { NavLink } from '@strapi/design-system/NavLink';
import { NavUser } from '@strapi/design-system/NavUser';
import { NavBrand } from '@strapi/design-system/NavBrand';
      ...
      return (
        <Box background="neutral100" padding={10} style={{ height: '100vh' }}>
          <MainNav>
            ...
            <NavCondense>{condensed ? 'Expanded the navbar' : 'Collapse the navbar'}</NavCondense>
          </MainNav>
        </Box>
      );
    }}
